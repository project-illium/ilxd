...
var file_ilxrpc_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x64, 0x72, 0x73, 0x22, 0x56, 0x0a, 0x11, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x54,
	...
	0x01, 0x28, 0x03, 0x52, 0x08, 0x6e, 0x65, 0x74, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x32, 0xd1, 0x0a,
...
var file_ilxrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 152)
var file_ilxrpc_proto_goTypes = []interface{}{
	...
	(*blocks.Block)(nil),                            // 154: Block
	(*blocks.CompressedBlock)(nil),                  // 155: CompressedBlock
	(*blocks.BlockHeader)(nil),                      // 156: BlockHeader
	(*transactions.Transaction)(nil),                // 157: Transaction
}
var file_ilxrpc_proto_depIdxs = []int32{
	...
	154, // 3: pb.GetBlockResponse.block:type_name -> Block
	155, // 4: pb.GetCompressedBlockResponse.block:type_name -> CompressedBlock
	156, // 5: pb.GetHeadersResponse.headers:type_name -> BlockHeader
	155, // 6: pb.GetCompressedBlocksResponse.blocks:type_name -> CompressedBlock
	157, // 7: pb.GetTransactionResponse.tx:type_name -> Transaction
	...
	157, // 11: pb.SubmitTransactionRequest.transaction:type_name -> Transaction
	157, // 12: pb.GetWalletTransactionsResponse.transactions:type_name -> Transaction
	...
	157, // 16: pb.CreateMultiSignatureRequest.tx:type_name -> Transaction
	144, // 17: pb.ProveMultisigRequest.raw_tx:type_name -> pb.RawTransaction
	157, // 18: pb.ProveMultisigResponse.proved_tx:type_name -> Transaction
	...
	157, // 25: pb.ProveRawTransactionResponse.proved_tx:type_name -> Transaction
	148, // 26: pb.GetPeersResponse.peers:type_name -> pb.Peer
	1,   // 27: pb.SetLogLevelRequest.level:type_name -> pb.SetLogLevelRequest.Level
	157, // 28: pb.TransactionNotification.transaction:type_name -> Transaction
	...
	155, // 32: pb.CompressedBlockNotification.block:type_name -> CompressedBlock
	157, // 33: pb.TransactionData.transaction:type_name -> Transaction
	153, // 34: pb.Validator.stake:type_name -> pb.Validator.Stake
	157, // 35: pb.RawTransaction.tx:type_name -> Transaction
	...
	145, // 39: pb.CreateRawTransactionRequest.Input.input:type_name -> pb.PrivateInput
	145, // 40: pb.CreateRawStakeTransactionRequest.Input.input:type_name -> pb.PrivateInput
	...
	100, // 92: pb.WalletService.SubscribeWalletSyncNotifications:input_type -> pb.SubscribeWalletSyncNotificationsRequest
	101, // 93: pb.NodeService.GetHostInfo:input_type -> pb.GetHostInfoRequest
	103, // 94: pb.NodeService.GetNetworkKey:input_type -> pb.GetNetworkKeyRequest
	105, // 95: pb.NodeService.GetPeers:input_type -> pb.GetPeersRequest
	107, // 96: pb.NodeService.AddPeer:input_type -> pb.AddPeerRequest
	109, // 97: pb.NodeService.BlockPeer:input_type -> pb.BlockPeerRequest
	111, // 98: pb.NodeService.UnblockPeer:input_type -> pb.UnblockPeerRequest
	113, // 99: pb.NodeService.SetLogLevel:input_type -> pb.SetLogLevelRequest
	115, // 100: pb.NodeService.GetMinFeePerKilobyte:input_type -> pb.GetMinFeePerKilobyteRequest
	117, // 101: pb.NodeService.SetMinFeePerKilobyte:input_type -> pb.SetMinFeePerKilobyteRequest
	119, // 102: pb.NodeService.GetMinStake:input_type -> pb.GetMinStakeRequest
	121, // 103: pb.NodeService.SetMinStake:input_type -> pb.SetMinStakeRequest
	123, // 104: pb.NodeService.GetBlockSizeSoftLimit:input_type -> pb.GetBlockSizeSoftLimitRequest
	125, // 105: pb.NodeService.SetBlockSizeSoftLimit:input_type -> pb.SetBlockSizeSoftLimitRequest
	127, // 106: pb.NodeService.GetTreasuryWhitelist:input_type -> pb.GetTreasuryWhitelistRequest
	129, // 107: pb.NodeService.UpdateTreasuryWhitelist:input_type -> pb.UpdateTreasuryWhitelistRequest
	131, // 108: pb.NodeService.ReconsiderBlock:input_type -> pb.ReconsiderBlockRequest
	133, // 109: pb.NodeService.RecomputeChainState:input_type -> pb.RecomputeChainStateRequest
	3,   // 110: pb.BlockchainService.GetMempoolInfo:output_type -> pb.GetMempoolInfoResponse
	5,   // 111: pb.BlockchainService.GetMempool:output_type -> pb.GetMempoolResponse
	7,   // 112: pb.BlockchainService.GetBlockchainInfo:output_type -> pb.GetBlockchainInfoResponse
	9,   // 113: pb.BlockchainService.GetBlockInfo:output_type -> pb.GetBlockInfoResponse
	11,  // 114: pb.BlockchainService.GetBlock:output_type -> pb.GetBlockResponse
	13,  // 115: pb.BlockchainService.GetCompressedBlock:output_type -> pb.GetCompressedBlockResponse
	15,  // 116: pb.BlockchainService.GetHeaders:output_type -> pb.GetHeadersResponse
	17,  // 117: pb.BlockchainService.GetCompressedBlocks:output_type -> pb.GetCompressedBlocksResponse
	19,  // 118: pb.BlockchainService.GetTransaction:output_type -> pb.GetTransactionResponse
	21,  // 119: pb.BlockchainService.GetMerkleProof:output_type -> pb.GetMerkleProofResponse
	23,  // 120: pb.BlockchainService.GetValidator:output_type -> pb.GetValidatorResponse
	25,  // 121: pb.BlockchainService.GetValidatorSetInfo:output_type -> pb.GetValidatorSetInfoResponse
	27,  // 122: pb.BlockchainService.GetValidatorSet:output_type -> pb.GetValidatorSetResponse
	29,  // 123: pb.BlockchainService.GetAccumulatorCheckpoint:output_type -> pb.GetAccumulatorCheckpointResponse
	31,  // 124: pb.BlockchainService.SubmitTransaction:output_type -> pb.SubmitTransactionResponse
	138, // 125: pb.BlockchainService.SubscribeBlocks:output_type -> pb.BlockNotification
	139, // 126: pb.BlockchainService.SubscribeCompressedBlocks:output_type -> pb.CompressedBlockNotification
	35,  // 127: pb.WalletServerService.RegisterViewKey:output_type -> pb.RegisterViewKeyResponse
	135, // 128: pb.WalletServerService.SubscribeTransactions:output_type -> pb.TransactionNotification
	38,  // 129: pb.WalletServerService.GetWalletTransactions:output_type -> pb.GetWalletTransactionsResponse
	40,  // 130: pb.WalletServerService.GetTxoProof:output_type -> pb.GetTxoProofResponse
	42,  // 131: pb.WalletService.GetBalance:output_type -> pb.GetBalanceResponse
	44,  // 132: pb.WalletService.GetWalletSeed:output_type -> pb.GetWalletSeedResponse
	46,  // 133: pb.WalletService.GetAddress:output_type -> pb.GetAddressResponse
	48,  // 134: pb.WalletService.GetTimelockedAddress:output_type -> pb.GetTimelockedAddressResponse
	50,  // 135: pb.WalletService.GetAddresses:output_type -> pb.GetAddressesResponse
	52,  // 136: pb.WalletService.GetAddressInfo:output_type -> pb.GetAddressInfoResponse
	54,  // 137: pb.WalletService.GetNewAddress:output_type -> pb.GetNewAddressResponse
	56,  // 138: pb.WalletService.GetTransactions:output_type -> pb.GetTransactionsResponse
	58,  // 139: pb.WalletService.GetUtxos:output_type -> pb.GetUtxosResponse
	60,  // 140: pb.WalletService.GetPrivateKey:output_type -> pb.GetPrivateKeyResponse
	62,  // 141: pb.WalletService.ImportAddress:output_type -> pb.ImportAddressResponse
	64,  // 142: pb.WalletService.CreateMultisigSpendKeypair:output_type -> pb.CreateMultisigSpendKeypairResponse
	66,  // 143: pb.WalletService.CreateMultisigViewKeypair:output_type -> pb.CreateMultisigViewKeypairResponse
	68,  // 144: pb.WalletService.CreateMultisigAddress:output_type -> pb.CreateMultisigAddressResponse
	70,  // 145: pb.WalletService.CreateMultiSignature:output_type -> pb.CreateMultiSignatureResponse
	72,  // 146: pb.WalletService.ProveMultisig:output_type -> pb.ProveMultisigResponse
	74,  // 147: pb.WalletService.WalletLock:output_type -> pb.WalletLockResponse
	76,  // 148: pb.WalletService.WalletUnlock:output_type -> pb.WalletUnlockResponse
	78,  // 149: pb.WalletService.SetWalletPassphrase:output_type -> pb.SetWalletPassphraseResponse
	80,  // 150: pb.WalletService.ChangeWalletPassphrase:output_type -> pb.ChangeWalletPassphraseResponse
	82,  // 151: pb.WalletService.DeletePrivateKeys:output_type -> pb.DeletePrivateKeysResponse
	84,  // 152: pb.WalletService.CreateRawTransaction:output_type -> pb.CreateRawTransactionResponse
	86,  // 153: pb.WalletService.CreateRawStakeTransaction:output_type -> pb.CreateRawStakeTransactionResponse
	88,  // 154: pb.WalletService.ProveRawTransaction:output_type -> pb.ProveRawTransactionResponse
	90,  // 155: pb.WalletService.Stake:output_type -> pb.StakeResponse
	92,  // 156: pb.WalletService.SetAutoStakeRewards:output_type -> pb.SetAutoStakeRewardsResponse
	94,  // 157: pb.WalletService.Spend:output_type -> pb.SpendResponse
	96,  // 158: pb.WalletService.TimelockCoins:output_type -> pb.TimelockCoinsResponse
	98,  // 159: pb.WalletService.SweepWallet:output_type -> pb.SweepWalletResponse
	136, // 160: pb.WalletService.SubscribeWalletTransactions:output_type -> pb.WalletTransactionNotification
	137, // 161: pb.WalletService.SubscribeWalletSyncNotifications:output_type -> pb.WalletSyncNotification
	102, // 162: pb.NodeService.GetHostInfo:output_type -> pb.GetHostInfoResponse
	104, // 163: pb.NodeService.GetNetworkKey:output_type -> pb.GetNetworkKeyResponse
	106, // 164: pb.NodeService.GetPeers:output_type -> pb.GetPeersResponse
	108, // 165: pb.NodeService.AddPeer:output_type -> pb.AddPeerResponse
	110, // 166: pb.NodeService.BlockPeer:output_type -> pb.BlockPeerResponse
	112, // 167: pb.NodeService.UnblockPeer:output_type -> pb.UnblockPeerResponse
	114, // 168: pb.NodeService.SetLogLevel:output_type -> pb.SetLogLevelResponse
	116, // 169: pb.NodeService.GetMinFeePerKilobyte:output_type -> pb.GetMinFeePerKilobyteResponse
	118, // 170: pb.NodeService.SetMinFeePerKilobyte:output_type -> pb.SetMinFeePerKilobyteResponse
	120, // 171: pb.NodeService.GetMinStake:output_type -> pb.GetMinStakeResponse
	122, // 172: pb.NodeService.SetMinStake:output_type -> pb.SetMinStakeResponse
	124, // 173: pb.NodeService.GetBlockSizeSoftLimit:output_type -> pb.GetBlockSizeSoftLimitResponse
	126, // 174: pb.NodeService.SetBlockSizeSoftLimit:output_type -> pb.SetBlockSizeSoftLimitResponse
	128, // 175: pb.NodeService.GetTreasuryWhitelist:output_type -> pb.GetTreasuryWhitelistResponse
	130, // 176: pb.NodeService.UpdateTreasuryWhitelist:output_type -> pb.UpdateTreasuryWhitelistResponse
	132, // 177: pb.NodeService.ReconsiderBlock:output_type -> pb.ReconsiderBlockResponse
	134, // 178: pb.NodeService.RecomputeChainState:output_type -> pb.RecomputeChainStateResponse
	110, // [110:179] is the sub-list for method output_type
	41,  // [41:110] is the sub-list for method input_type
