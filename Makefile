...
protos:
	...
	cd types/wire && PATH=$(PATH):$(GOPATH)/bin protoc --go_out=. --proto_path=../transactions --proto_path=../blocks --proto_path=../wire *.proto *.proto
	...
	cd types/wire && sed -i '15i\"github.com/project-illium/ilxd/types/blocks"\' message.pb.go
